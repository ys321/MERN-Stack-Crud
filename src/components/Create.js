...
class Create extends Component {
  ...
  onSubmit = (e) => {
    ...
    const { isbn, title, author, description, published_year, publisher,demo } = this.state;

    axios.post('/api/book', { isbn, title, author, description, published_year, publisher,demo})
      .then((result) => {
